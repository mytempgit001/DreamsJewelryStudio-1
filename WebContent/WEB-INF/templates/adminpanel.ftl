...
<@sidebar.page>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="static/admin/img/undraw_posting_photo.svg" alt="">
                  </div>
  ...
  <!-- Page level plugins -->
  <script src="http://localhost:8080/static/admin/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="http://localhost:8080/static/admin/js/demo/chart-area-demo.js"></script>
  <script src="http://localhost:8080/static/admin/js/demo/chart-pie-demo.js"></script>
